...
export const RequiredRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
...
export const MinRuleListItem: React.FC<RuleListRendererProps> = ({ rule, onEdit, onDelete }) => {
  const numberRule = rule as Extract<PathValidationRule, { type: 'min' }>;
  return (
    <RuleListItem
      title="Минимум"
      description={`Значение: ${numberRule.value}`}
      onEdit={onEdit}
      onDelete={onDelete}
    />
  );
...
export const MaxRuleListItem: React.FC<RuleListRendererProps> = ({ rule, onEdit, onDelete }) => {
...
export const PatternRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
...
export const DistinctRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
...
export const RequiredIfRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
...
export const ProhibitedUnlessRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
...
export const RequiredUnlessRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
...
export const ProhibitedIfRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
...
export const FieldComparisonRuleListItem: React.FC<RuleListRendererProps> = ({
  rule,
  onEdit,
  onDelete,
}) => {
